...
var _excluded2 = ["horizontal", "factor", "offset", "speed", "sticky"];
var _excluded22 = ["pages", "innerStyle", "config", "enabled", "horizontal", "children"];
...
function mapChildrenRecursive(children, callback) {
  ...
  return React3.Children.map(children, (child) => isReactFragment(child) ? mapChildrenRecursive(child.props.children, callback) : callback(child));
}
var START_TRANSLATE_3D = "translate3d(0px,0px,0px)";
var START_TRANSLATE = "translate(0px,0px)";
var ParallaxLayer = React3.memo(React3.forwardRef((_ref, ref) => {
  let {
    horizontal,
    factor = 1,
    offset = 0,
  ...
  const parent = (0, import_react4.useContext)(ParentContext);
  ...
  const layerRef = (0, import_react4.useRef)();
  ...
  return React3.createElement(animated.div, _extends4({}, rest, {
    ref: layerRef,
    style: _extends4({
      position: "absolute",
      top: 0,
...
var Parallax = React3.memo(React3.forwardRef((props, ref) => {
  ...
  const {
    ...
    horizontal = false,
    children
  } = props, rest = _objectWithoutPropertiesLoose3(props, _excluded22);
  const containerRef = (0, import_react4.useRef)();
  const contentRef = (0, import_react4.useRef)();
  ...
  (0, import_react4.useEffect)(() => state.update());
  useOnce(() => {
    setReady(true);
    const onResize = () => {
      const update4 = () => state.update();
      raf.onFrame(update4);
      setTimeout(update4, 150);
    };
  ...
  }), ready && React3.createElement(React3.Fragment, null, React3.createElement(animated.div, {
    ref: contentRef,
    style: _extends4({
      overflow: "hidden",
      position: "absolute",
  ...
  }, React3.createElement(ParentContext.Provider, {
    value: state
  }, mapChildrenRecursive(children, (child) => !child.props.sticky && child))), React3.createElement(ParentContext.Provider, {
    value: state
